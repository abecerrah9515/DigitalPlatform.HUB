      ...
      <div class="bg-white rounded-xl border border-slate-200 px-5 py-4">
        <div class="grid grid-cols-3 gap-4">
          ...
          <div class="flex flex-col gap-1">
            ...
            <input type="text" [(ngModel)]="filtroProyecto"
              class="w-full px-3 py-2 text-sm rounded-lg border border-slate-200 bg-white text-slate-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors"
        ...
        @for (proy of proyectosFiltrados(); track proy.id) {
          <div (click)="seleccionarProyecto(proy)"
            ...
            <div class="min-w-0 flex-1">
              <p class="text-sm font-semibold text-slate-900">{{ proy.nombre }}</p>
              <p class="text-xs text-slate-400 mt-0.5">
                <span class="font-mono">{{ proy.codigo }}</span>
      ...
      @if (proyectoSeleccionado(); as proy) {
        <div class="bg-white rounded-xl border border-slate-200 overflow-hidden">
          ...
          <div class="bg-gradient-to-r from-blue-600 to-indigo-600 px-6 py-4">
            <p class="text-lg font-semibold text-white">{{ proy.nombre }}</p>
          ...
          <!-- Directorio Table -->
          <div class="px-6 py-5">
            <h3 class="text-sm font-semibold text-slate-900 mb-3">Directorio</h3>
            ...
            <div class="flex items-center gap-3 mt-5">
              ...
              <label
                ...
                Cargar archivo actualización directorio
...
export class SubproyectosComponent implements OnInit {
  ...
  private cargarDatos() {
    this.carteraSvc.getSubProyectosResumen().subscribe(r => this.resumen.set(r));
    this.carteraSvc.getSubProyectosLista().subscribe(r => this.proyectos.set(r));
  }
